...
(function (global, factory) {
  ...
  var ReactSwipe = (function (_Component) {
    ...
    _createClass(ReactSwipe, [{
      ...
      value: function _handleSwipeMove(e) {
        ...
        var direction = Math.abs(deltaX) < Math.abs(deltaY) ? ReactSwipe.vertical : ReactSwipe.horizontal;
        if(0 == (this.props.direction & direction))
            return;
        e.preventDefault();
        this.swiping = true;
  ...
  ReactSwipe.propTypes = {
    ...
    direction: _react.PropTypes.oneOf([ReactSwipe.vertical,ReactSwipe.horizontal,ReactSwipe.both])
  };
